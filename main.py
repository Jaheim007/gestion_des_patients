...
btn1 = Button(window, text=" Se Connecter ", command= fonctions.connexion, font="Roboto 15", width=15, height=2).pack(pady=50)
btn2 = Button(window, text=" S'Inscrire " , command= fonctions.inscription, font="Roboto 15", width=15, height=2).pack(pady=40)
